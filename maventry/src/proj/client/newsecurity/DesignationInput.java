...
public class DesignationInput extends Composite {
...
//        setAnimationEnabled(true);
        ...
        HorizontalPanel hreturn = new HorizontalPanel();
 
        hreturn.add(mainPanel);
        
        initWidget(hreturn);
    }


	public TextBox getDesigname() {
		return designame;
	}


	public void setDesigname(TextBox designame) {
		this.designame = designame;
	}


	public TextBox getMaxSalary() {
		return maxSalary;
	}


	public void setMaxSalary(TextBox maxSalary) {
		this.maxSalary = maxSalary;
	}


	public TextBox getMinSalary() {
		return minSalary;
	}


	public void setMinSalary(TextBox minSalary) {
