...
public class EmployeeForm extends Composite {
		...
		public EmployeeForm(Employee pass) {
...
//	         });
		...
		public TextBox getSalaryTextBox() {
			return salaryTextBox;
		}
		public void setSalaryTextBox(TextBox salaryTextBox) {
			this.salaryTextBox = salaryTextBox;
		}
